...
document.write('<nav> <input type="checkbox" id="check"> </input> <label for="check" class="checkbtn"> <i class="fas fa-bars"></i> </label> <ul> <li><a class="" href="index.html">Inicio</a></li>  <li><a class="" href="vehiculos.html">Vehiculos</a></li>  <li><a href="mas_buscados.html">Más buscados</a></li> <li class="nav-item dropdown" id="crudv"   ><a class="dropdown-item" href="crud.html">CRUD</a></li><li class="nav-item"><a id="rgtr" class="nav-link" href="registro.html">Registro</a></li><li class="nav-item"><a id="lgn" class="nav-link" href="login.html">Login</a></li>  <li id="user"><i class="fa-solid fa-user"></i></li>      <li> <button  id="logout" onclick="logout()" type="button" class="logout">Salir</button> </li> </ul>    </nav>  ')
// document.write
...
if(sessionStorage.getItem("adm")==null){
    ...
    document.querySelector("#user").setAttribute('style', 'display:on')
