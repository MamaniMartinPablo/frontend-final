...
document.write('<nav> <input type="checkbox" id="check"> </input> <label for="check" class="checkbtn"> <i class="fas fa-bars"></i> </label> <ul> <li><a class="active" href="index.html">Home</a></li>    <li><a href="mas_buscados.html">Más buscados</a></li> <li class="nav-item dropdown" id="crudv"   ><a class="dropdown-item" href="informacion.html">CRUD autos</a></li><li class="nav-item"><a class="nav-link" href="registro.html">Registro</a></li><li class="nav-item"><a class="nav-link" href="login.html">Login</a></li> <button  id="logout" onclick="logout()" type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-log-out"></span>Logout</button>  </ul>    </nav>  ')
// document.write
